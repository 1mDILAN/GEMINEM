        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('clientes.update', $cliente->id) }}" class="row g-3">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="col-12">
                            <button type="submit" class="btn btn-outline-primary w-full">Actualizar Cliente</button>
                        </div>
                    </form>
                </div>
            </div>
